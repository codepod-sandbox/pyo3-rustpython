...
#[allow(dead_code)]
mod build {
    pub const PKG_VERSION: &str = "0.45.1";
    pub const PKG_NAME: &str = "jsonschema-rs";
}
...
fn jsonschema_rs(py: Python<'_>, module: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    types::init(py);
    module.add_wrapped(wrap_pyfunction!(is_valid, &module))?;
    module.add_wrapped(wrap_pyfunction!(validate, &module))?;
    module.add_wrapped(wrap_pyfunction!(iter_errors, &module))?;
    module.add_wrapped(wrap_pyfunction!(evaluate, &module))?;
    module.add_wrapped(wrap_pyfunction!(validator_for, &module))?;
    module.add_wrapped(wrap_pyfunction!(bundle, &module))?;
    module.add_wrapped(wrap_pyfunction!(validator_cls_for, &module))?;
    ...
    module.add("__build__", pyo3_built!(py, build))?;
